...
(function() {
  ...
  MT("test EQName variable",
     "[keyword declare] [keyword variable] [variable $\"http://www.example.com/ns/my\":var] [keyword :=] [atom waypoints][variable ;]",
  ...
  MT("test EQName function",
     ...
     "}[variable ;]",
     "[tag <out>]{[def&variable \"http://www.example.com/ns/my\":fn]([atom waypoints])}[tag </out>]");
